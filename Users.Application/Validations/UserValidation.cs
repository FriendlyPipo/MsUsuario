    ...
    public class UserValidation : AbstractValidator<CreateUserDTO>
    {
        public UserValidation()
        {
            ...
            RuleFor(x => x.UserType)
                ...
                .Must(type => type == "Usuario" || type == "Organizador" || type == "Administrador" || type == "Soporte")
                .WithMessage("El tipo de usuario debe ser 'Usuario', 'Organizador', 'Administrador' o 'Soporte'");
        }
